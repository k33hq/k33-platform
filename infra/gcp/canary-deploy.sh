...
# stripe
STRIPE_PRODUCT_ID_RESEARCH_PRO=$(op read op://k33-platform-env/$ENV/stripe/STRIPE_PRODUCT_ID_RESEARCH_PRO)
STRIPE_COUPON_CORPORATE_PLAN=$(op read op://k33-platform-env/$ENV/stripe/STRIPE_COUPON_CORPORATE_PLAN)
# slack
SLACK_ALERTS_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_ALERTS_CHANNEL_ID)
SLACK_GENERAL_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_GENERAL_CHANNEL_ID)
SLACK_INVEST_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_INVEST_CHANNEL_ID)
SLACK_PRODUCT_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_PRODUCT_CHANNEL_ID)
SLACK_PROFESSIONAL_INVESTORS_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_PROFESSIONAL_INVESTORS_CHANNEL_ID)
SLACK_RESEARCH_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_RESEARCH_CHANNEL_ID)
SLACK_RESEARCH_EVENTS_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_RESEARCH_EVENTS_CHANNEL_ID)
SLACK_VAULT_ADMIN_CHANNEL_ID=$(op read op://k33-platform-env/$ENV/slack/SLACK_VAULT_ADMIN_CHANNEL_ID)
# sendgrid
SENDGRID_TEMPLATE_ID_WELCOME_TO_K33=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_WELCOME_TO_K33)
SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH)
SENDGRID_UNSUBSCRIBE_GROUP_ID_K33=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_UNSUBSCRIBE_GROUP_ID_K33)
SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH)
## TWIC
SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_TWIC=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_TWIC)
SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_TWIC=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_TWIC)
SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_TWIC=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_TWIC)
## NN
SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_NN=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_NN)
SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_NN=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_NN)
SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_NN=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_NN)
## AOC
SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_AOC=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_AOC)
SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_AOC=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_AOC)
SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_AOC=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_AOC)
## PRO
SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_PRO_TRIAL=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_PRO_TRIAL)
SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_PRO=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_WELCOME_TO_K33_RESEARCH_PRO)
SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_PRO=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_CONTACT_LIST_ID_K33_RESEARCH_PRO)
SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_PRO=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_UNSUBSCRIBE_GROUP_ID_K33_RESEARCH_PRO)
# lifecycle
SENDGRID_TEMPLATE_ID_CANCEL_DURING_TRIAL_K33_RESEARCH_PRO=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_CANCEL_DURING_TRIAL_K33_RESEARCH_PRO)
# stripe cronjob
SENDGRID_TEMPLATE_ID_NEW_USER_OFFER_K33_RESEARCH=$(op read op://k33-platform-env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_NEW_USER_OFFER_K33_RESEARCH)
# ga
GOOGLE_ANALYTICS_FIREBASE_APP_ID=$(op read op://k33-platform-env/$ENV/analytics/GOOGLE_ANALYTICS_FIREBASE_APP_ID)
GOOGLE_ANALYTICS_MEASUREMENT_ID=$(op read op://k33-platform-env/$ENV/analytics/GOOGLE_ANALYTICS_MEASUREMENT_ID)
# for invest app
INVEST_DENIED_COUNTRY_CODE_LIST=$(op read op://k33-platform-env/$ENV/invest/INVEST_DENIED_COUNTRY_CODE_LIST)
INVEST_EMAIL_FROM=$(op read op://k33-platform-env/$ENV/invest/INVEST_EMAIL_FROM)
INVEST_EMAIL_TO_LIST=$(op read op://k33-platform-env/$ENV/invest/INVEST_EMAIL_TO_LIST)
INVEST_EMAIL_CC_LIST=$(op read op://k33-platform-env/$ENV/invest/INVEST_EMAIL_CC_LIST)
INVEST_EMAIL_BCC_LIST=$(op read op://k33-platform-env/$ENV/invest/INVEST_EMAIL_BCC_LIST)
# for vault app
## coin_gecko
COIN_GECKO_API_KEY=$(op read op://k33-platform-env/$ENV/vault/COIN_GECKO_API_KEY)
