...
SLACK_VAULT_ADMIN_CHANNEL_ID=$(op read op://env/$ENV/slack/SLACK_VAULT_ADMIN_CHANNEL_ID)
# sendgrid
...
# stripe cronjob
SENDGRID_TEMPLATE_ID_NEW_USER_OFFER_K33_RESEARCH=$(op read op://env/$ENV/sendgrid/SENDGRID_TEMPLATE_ID_NEW_USER_OFFER_K33_RESEARCH)
# ga
